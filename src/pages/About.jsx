      ...
      <section className=' bg-richblack-700'>
         <div className=' relative mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-center text-white'>
            <header className="mx-auto py-20 text-4xl font-semibold lg:w-[70%]">
                 ...
                 Eduganga is at the forefront of driving innovation in online education. 
      ...
      <div className=' flex flex-col  w-11/12 max-w-maxContent mx-auto justify-between gap-10 text-richblack-500'>
          ...
          {/* left upper box */}
              <div className="my-24 flex lg:w-[50%] flex-col gap-10">
                 ...
                 who recognized the need for accessible, flexible, and high-quality learning opportunities in a rapidly evolving digital world.</p>
          ...
          {/* left vision box */}
            ...
            <div className="my-24 flex lg:w-[40%] flex-col gap-10">
                ...
                <p className="text-base font-medium text-richblack-300 lg:w-[95%]">Our mission goes beyond just delivering courses online. We wanted to create a vibrant community of learners, where individuals can connect, collaborate, and learn from one another. 
